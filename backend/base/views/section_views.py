...
from base.serializers import ProductSerializer, UserSerializer, UserSerializerWithToken, BrandSerializer, SectionSerializer
...
def getSection(request, pk):
    ...
    serializers = SectionSerializer(section, many=False)
